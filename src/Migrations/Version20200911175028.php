 ...
 */
final class Version20200911175028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE etudiant ADD user_id INT DEFAULT NULL, ADD created_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE etudiant DROP user_id, DROP created_at');
    }
}
